...
//
//  val srctype0 :: srctype1 :: fu :: fuop :: instrtype :: xWen :: cpuTrap :: noSpec :: blockBack :: flushPipe :: Nil =
//    decoder
//
...
//  val imm = MuxLookup(instrtype, 0.U)(
//    Seq(
...
//    isRet(instr),
//    Brtype.ret,
//    Mux(isCall(instr), Brtype.call, Mux(FuType.isbrh(fu), Brtype.branch, Brtype.jump))
//  )
//
